...
steps:
  - Confirm the requested incident postmortem and analysis outcome, scope, owner, and success criteria
...
Use this skill when a task explicitly matches `platform.incident-analysis` or when the user asks for incident postmortem and analysis support. It is designed for bounded task work where the agent needs concrete inputs, a repeatable procedure, and verification before handoff.
...
**Example A:** A user asks for incident postmortem and analysis help with a specific file or dataset; apply the six-step procedure and return a concise, evidence-backed artifact.

...
steps:
  - Confirm the requested oauth 2 0 implementation review outcome, scope, owner, and success criteria
...
## Trigger
Use this skill when a task explicitly matches `security.oauth2-flows` or when the user asks for oauth 2 0 implementation review support. It is designed for bounded task work where the agent needs concrete inputs, a repeatable procedure, and verification before handoff.
...
## Examples
**Example A:** A user asks for oauth 2 0 implementation review help with a specific file or dataset; apply the six-step procedure and return a concise, evidence-backed artifact.

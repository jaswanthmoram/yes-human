...
steps:
  - Confirm the requested authentication flow security review outcome, scope, owner, and success criteria
...
Use this skill when a task explicitly matches `security.auth-review` or when the user asks for authentication flow security review support. It is designed for bounded task work where the agent needs concrete inputs, a repeatable procedure, and verification before handoff.
...
**Example A:** A user asks for authentication flow security review help with a specific file or dataset; apply the six-step procedure and return a concise, evidence-backed artifact.

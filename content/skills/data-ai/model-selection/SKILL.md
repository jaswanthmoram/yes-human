...
purpose: Execute model selection work with evidence, verification, and clear handoff rules.
...
steps:
  - Confirm the requested model selection outcome, scope, owner, and success criteria
...
## Trigger
Use this skill when a task explicitly matches `data-ai.model-selection` or when the user asks for model selection support. It is designed for bounded task work where the agent needs concrete inputs, a repeatable procedure, and verification before handoff.
...
## Examples
**Example A:** A user asks for model selection help with a specific file or dataset; apply the six-step procedure and return a concise, evidence-backed artifact.

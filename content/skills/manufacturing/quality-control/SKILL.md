...
activation_triggers:
  - help me with quality control
  - review quality control work
prerequisites:
...
steps:
  - Confirm the requested quality control outcome, scope, owner, and success criteria
...
## Trigger
Use this skill when a task explicitly matches `manufacturing.quality-control` or when the user asks for quality control support. It is designed for bounded task work where the agent needs concrete inputs, a repeatable procedure, and verification before handoff.
...
## Examples
**Example A:** A user asks for quality control help with a specific file or dataset; apply the six-step procedure and return a concise, evidence-backed artifact.

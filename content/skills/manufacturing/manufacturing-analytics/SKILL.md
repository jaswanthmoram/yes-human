...
activation_triggers:
  - help me with manufacturing analytics
  - review manufacturing analytics work
prerequisites:
...
steps:
  - Confirm the requested manufacturing analytics outcome, scope, owner, and success criteria
...
## Trigger
Use this skill when a task explicitly matches `manufacturing.manufacturing-analytics` or when the user asks for manufacturing analytics support. It is designed for bounded task work where the agent needs concrete inputs, a repeatable procedure, and verification before handoff.
...
## Examples
**Example A:** A user asks for manufacturing analytics help with a specific file or dataset; apply the six-step procedure and return a concise, evidence-backed artifact.

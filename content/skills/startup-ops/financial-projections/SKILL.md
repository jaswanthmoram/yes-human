...
steps:
  - Confirm the requested financial projections outcome, scope, owner, and success criteria
...
## Trigger
Use this skill when a task explicitly matches `startup-ops.financial-projections` or when the user asks for financial projections support. It is designed for bounded task work where the agent needs concrete inputs, a repeatable procedure, and verification before handoff.
...
## Examples
**Example A:** A user asks for financial projections help with a specific file or dataset; apply the six-step procedure and return a concise, evidence-backed artifact.

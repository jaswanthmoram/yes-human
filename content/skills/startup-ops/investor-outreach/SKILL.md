...
steps:
  - Confirm the requested investor outreach outcome, scope, owner, and success criteria
...
## Trigger
Use this skill when a task explicitly matches `startup-ops.investor-outreach` or when the user asks for investor outreach support. It is designed for bounded task work where the agent needs concrete inputs, a repeatable procedure, and verification before handoff.
...
## Examples
**Example A:** A user asks for investor outreach help with a specific file or dataset; apply the six-step procedure and return a concise, evidence-backed artifact.

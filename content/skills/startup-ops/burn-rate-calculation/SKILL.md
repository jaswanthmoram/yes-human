...
steps:
  - Confirm the requested burn rate and runway outcome, scope, owner, and success criteria
...
## Trigger
Use this skill when a task explicitly matches `startup-ops.burn-rate-calculation` or when the user asks for burn rate and runway support. It is designed for bounded task work where the agent needs concrete inputs, a repeatable procedure, and verification before handoff.
...
## Examples
**Example A:** A user asks for burn rate and runway help with a specific file or dataset; apply the six-step procedure and return a concise, evidence-backed artifact.

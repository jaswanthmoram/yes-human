...
triggers:
  ...
  - yes human task
  - customer interview framework review
...
steps:
  - Confirm the requested customer interview framework outcome, scope, owner, and success criteria
...
Use this skill when a task explicitly matches `startup-ops.customer-interviews` or when the user asks for customer interview framework support. It is designed for bounded task work where the agent needs concrete inputs, a repeatable procedure, and verification before handoff.
...
**Example A:** A user asks for customer interview framework help with a specific file or dataset; apply the six-step procedure and return a concise, evidence-backed artifact.

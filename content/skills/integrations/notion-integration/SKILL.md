...
triggers:
  ...
  - sync notion context
  - yes human task
  - notion integration review
activation_triggers:
  - use Notion as context
  - pull from Notion database
  - help me with notion integration
prerequisites:
...
steps:
  - Confirm the requested notion integration outcome, scope, owner, and success criteria
...
## Trigger
Use this skill when a task explicitly matches `integrations.notion-integration` or when the user asks for notion integration support. It is designed for bounded task work where the agent needs concrete inputs, a repeatable procedure, and verification before handoff.
...
## Examples
**Example A:** A user asks for notion integration help with a specific file or dataset; apply the six-step procedure and return a concise, evidence-backed artifact.
**Example B:** A user asks for a broad strategy without inputs; produce a scoped checklist, identify missing evidence, and mark recommendations as assumptions until reviewed.

## Source Notes
Reference patterns are drawn from https://github.com/microsoft/graphrag and https://github.com/lastmile-ai/mcp-agent and https://github.com/makenotion/notion-sdk-js. Use them for process patterns only; do not copy code or policy text unless license and project policy explicitly allow it.

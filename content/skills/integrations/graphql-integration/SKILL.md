...
triggers:
  ...
  - yes human task
  - graphql integration review
  - graphql integration checklist
  - graphql integration plan
activation_triggers:
  - connect graphql api
  - implement graphql
  - help me with graphql integration
prerequisites:
...
steps:
  - Confirm the requested graphql integration outcome, scope, owner, and success criteria
...
## Trigger
Use this skill when a task explicitly matches `integrations.graphql-integration` or when the user asks for graphql integration support. It is designed for bounded task work where the agent needs concrete inputs, a repeatable procedure, and verification before handoff.
...
## Examples
**Example A:** A user asks for graphql integration help with a specific file or dataset; apply the six-step procedure and return a concise, evidence-backed artifact.

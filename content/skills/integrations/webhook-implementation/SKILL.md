...
activation_triggers:
  ...
  - send webhooks
  - help me with webhook implementation
prerequisites:
...
steps:
  - Confirm the requested webhook implementation outcome, scope, owner, and success criteria
...
Use this skill when a task explicitly matches `integrations.webhook-implementation` or when the user asks for webhook implementation support. It is designed for bounded task work where the agent needs concrete inputs, a repeatable procedure, and verification before handoff.
...
**Example A:** A user asks for webhook implementation help with a specific file or dataset; apply the six-step procedure and return a concise, evidence-backed artifact.

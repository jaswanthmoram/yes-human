...
steps:
  - Confirm the requested api authentication outcome, scope, owner, and success criteria
...
## Trigger
Use this skill when a task explicitly matches `integrations.api-authentication` or when the user asks for api authentication support. It is designed for bounded task work where the agent needs concrete inputs, a repeatable procedure, and verification before handoff.
...
## Examples
**Example A:** A user asks for api authentication help with a specific file or dataset; apply the six-step procedure and return a concise, evidence-backed artifact.

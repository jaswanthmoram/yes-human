...
triggers:
  ...
  - yes human task
  - postman collections review
  - postman collections checklist
  - postman collections plan
activation_triggers:
  - organize api tests
  - postman workspace
  - help me with postman collections
prerequisites:
...
steps:
  - Confirm the requested postman collections outcome, scope, owner, and success criteria
...
## Trigger
Use this skill when a task explicitly matches `integrations.postman-collections` or when the user asks for postman collections support. It is designed for bounded task work where the agent needs concrete inputs, a repeatable procedure, and verification before handoff.
...
## Examples
**Example A:** A user asks for postman collections help with a specific file or dataset; apply the six-step procedure and return a concise, evidence-backed artifact.

...
activation_triggers:
  ...
  - help me with kafka integration
prerequisites:
...
steps:
  - Confirm the requested kafka integration outcome, scope, owner, and success criteria
...
## Trigger
Use this skill when a task explicitly matches `integrations.kafka-integration` or when the user asks for kafka integration support. It is designed for bounded task work where the agent needs concrete inputs, a repeatable procedure, and verification before handoff.
...
## Examples
**Example A:** A user asks for kafka integration help with a specific file or dataset; apply the six-step procedure and return a concise, evidence-backed artifact.

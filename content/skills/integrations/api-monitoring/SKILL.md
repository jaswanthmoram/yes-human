...
triggers:
  ...
  - yes human task
  - api monitoring review
  - api monitoring checklist
  - api monitoring plan
activation_triggers:
  - monitor api health
  - track api performance
  - help me with api monitoring
prerequisites:
...
steps:
  - Confirm the requested api monitoring outcome, scope, owner, and success criteria
...
Use this skill when a task explicitly matches `integrations.api-monitoring` or when the user asks for api monitoring support. It is designed for bounded task work where the agent needs concrete inputs, a repeatable procedure, and verification before handoff.
...
**Example A:** A user asks for api monitoring help with a specific file or dataset; apply the six-step procedure and return a concise, evidence-backed artifact.

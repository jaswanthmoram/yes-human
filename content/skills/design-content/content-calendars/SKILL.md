...
steps:
  - Confirm the requested content calendars outcome, scope, owner, and success criteria
...
## Trigger
Use this skill when a task explicitly matches `design-content.content-calendars` or when the user asks for content calendars support. It is designed for bounded task work where the agent needs concrete inputs, a repeatable procedure, and verification before handoff.
...
## Examples
**Example A:** A user asks for content calendars help with a specific file or dataset; apply the six-step procedure and return a concise, evidence-backed artifact.

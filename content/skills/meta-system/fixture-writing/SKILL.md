...
triggers:
  ...
  - yes human task
  - route and workflow fixture creation review
activation_triggers:
...
steps:
  - Confirm the requested route and workflow fixture creation outcome, scope, owner, and success criteria
...
## Trigger
Use this skill when a task explicitly matches `meta-system.fixture-writing` or when the user asks for route and workflow fixture creation support. It is designed for bounded task work where the agent needs concrete inputs, a repeatable procedure, and verification before handoff.
...
## Examples
**Example A:** A user asks for route and workflow fixture creation help with a specific file or dataset; apply the six-step procedure and return a concise, evidence-backed artifact.

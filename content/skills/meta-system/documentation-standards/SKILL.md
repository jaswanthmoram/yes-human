...
triggers:
  ...
  - documentation audit
  - yes human task
  - documentation standards and guidelines review
activation_triggers:
...
steps:
  - Confirm the requested documentation standards and guidelines outcome, scope, owner, and success criteria
...
## Trigger
Use this skill when a task explicitly matches `meta-system.documentation-standards` or when the user asks for documentation standards and guidelines support. It is designed for bounded task work where the agent needs concrete inputs, a repeatable procedure, and verification before handoff.
...
## Examples
**Example A:** A user asks for documentation standards and guidelines help with a specific file or dataset; apply the six-step procedure and return a concise, evidence-backed artifact.

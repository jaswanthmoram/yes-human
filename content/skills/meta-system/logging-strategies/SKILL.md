...
triggers:
  ...
  - debug logging setup
  - yes human task
  - logging strategy design and implementation review
activation_triggers:
...
steps:
  - Confirm the requested logging strategy design and implementation outcome, scope, owner, and success criteria
...
Use this skill when a task explicitly matches `meta-system.logging-strategies` or when the user asks for logging strategy design and implementation support. It is designed for bounded task work where the agent needs concrete inputs, a repeatable procedure, and verification before handoff.
...
**Example A:** A user asks for logging strategy design and implementation help with a specific file or dataset; apply the six-step procedure and return a concise, evidence-backed artifact.

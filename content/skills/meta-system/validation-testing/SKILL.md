...
triggers:
  ...
  - yes human task
  - validation testing and verification review
activation_triggers:
  - validation testing
...
steps:
  - Confirm the requested validation testing and verification outcome, scope, owner, and success criteria
...
## Trigger
Use this skill when a task explicitly matches `meta-system.validation-testing` or when the user asks for validation testing and verification support. It is designed for bounded task work where the agent needs concrete inputs, a repeatable procedure, and verification before handoff.
...
## Examples
**Example A:** A user asks for validation testing and verification help with a specific file or dataset; apply the six-step procedure and return a concise, evidence-backed artifact.

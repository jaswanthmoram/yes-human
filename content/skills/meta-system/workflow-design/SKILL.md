...
triggers:
  ...
  - yes human task
  - workflow design and orchestration review
activation_triggers:
...
steps:
  - Confirm the requested workflow design and orchestration outcome, scope, owner, and success criteria
...
## Trigger
Use this skill when a task explicitly matches `meta-system.workflow-design` or when the user asks for workflow design and orchestration support. It is designed for bounded task work where the agent needs concrete inputs, a repeatable procedure, and verification before handoff.
...
## Examples
**Example A:** A user asks for workflow design and orchestration help with a specific file or dataset; apply the six-step procedure and return a concise, evidence-backed artifact.

...
triggers:
  ...
  - yes human task
  - dossier creation and source assembly review
activation_triggers:
  - dossier creation
...
steps:
  - Confirm the requested dossier creation and source assembly outcome, scope, owner, and success criteria
...
Use this skill when a task explicitly matches `meta-system.dossier-creation` or when the user asks for dossier creation and source assembly support. It is designed for bounded task work where the agent needs concrete inputs, a repeatable procedure, and verification before handoff.
...
**Example A:** A user asks for dossier creation and source assembly help with a specific file or dataset; apply the six-step procedure and return a concise, evidence-backed artifact.

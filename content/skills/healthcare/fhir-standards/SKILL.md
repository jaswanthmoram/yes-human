...
triggers:
  ...
  - yes human task
activation_triggers:
  - help me with fhir standards implementation
  - review fhir standards implementation work
prerequisites:
...
steps:
  - Confirm the requested fhir standards implementation outcome, scope, owner, and success criteria
...
## Trigger
Use this skill when a task explicitly matches `healthcare.fhir-standards` or when the user asks for fhir standards implementation support. It is designed for bounded task work where the agent needs concrete inputs, a repeatable procedure, and verification before handoff.
...
## Examples
**Example A:** A user asks for fhir standards implementation help with a specific file or dataset; apply the six-step procedure and return a concise, evidence-backed artifact.

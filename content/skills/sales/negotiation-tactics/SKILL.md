...
steps:
  - Confirm the requested negotiation tactics framework outcome, scope, owner, and success criteria
...
Use this skill when a task explicitly matches `sales.negotiation-tactics` or when the user asks for negotiation tactics framework support. It is designed for bounded task work where the agent needs concrete inputs, a repeatable procedure, and verification before handoff.
...
**Example A:** A user asks for negotiation tactics framework help with a specific file or dataset; apply the six-step procedure and return a concise, evidence-backed artifact.

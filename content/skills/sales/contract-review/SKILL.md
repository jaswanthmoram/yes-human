...
triggers:
  ...
  - deal terms review
activation_triggers:
  - help me with contract review for sales
  - review contract review for sales work
prerequisites:
...
steps:
  - Confirm the requested contract review for sales outcome, scope, owner, and success criteria
...
Use this skill when a task explicitly matches `sales.contract-review` or when the user asks for contract review for sales support. It is designed for bounded task work where the agent needs concrete inputs, a repeatable procedure, and verification before handoff.
...
**Example A:** A user asks for contract review for sales help with a specific file or dataset; apply the six-step procedure and return a concise, evidence-backed artifact.

...
activation_triggers:
  - help me with pipeline management framework
  - review pipeline management framework work
prerequisites:
...
steps:
  - Confirm the requested pipeline management framework outcome, scope, owner, and success criteria
...
## Trigger
Use this skill when a task explicitly matches `sales.pipeline-management` or when the user asks for pipeline management framework support. It is designed for bounded task work where the agent needs concrete inputs, a repeatable procedure, and verification before handoff.
...
## Examples
**Example A:** A user asks for pipeline management framework help with a specific file or dataset; apply the six-step procedure and return a concise, evidence-backed artifact.

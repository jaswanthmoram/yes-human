...
activation_triggers:
  ...
  - help me with closing techniques framework
  - review closing techniques framework work
prerequisites:
...
steps:
  - Confirm the requested closing techniques framework outcome, scope, owner, and success criteria
...
## Trigger
Use this skill when a task explicitly matches `sales.closing-techniques` or when the user asks for closing techniques framework support. It is designed for bounded task work where the agent needs concrete inputs, a repeatable procedure, and verification before handoff.
...
## Examples
**Example A:** A user asks for closing techniques framework help with a specific file or dataset; apply the six-step procedure and return a concise, evidence-backed artifact.

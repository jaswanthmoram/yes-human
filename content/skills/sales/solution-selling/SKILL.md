...
steps:
  - Confirm the requested solution selling framework outcome, scope, owner, and success criteria
...
Use this skill when a task explicitly matches `sales.solution-selling` or when the user asks for solution selling framework support. It is designed for bounded task work where the agent needs concrete inputs, a repeatable procedure, and verification before handoff.
...
**Example A:** A user asks for solution selling framework help with a specific file or dataset; apply the six-step procedure and return a concise, evidence-backed artifact.

...
activation_triggers:
  - help me with product demo design
  - review product demo design work
prerequisites:
...
steps:
  - Confirm the requested product demo design outcome, scope, owner, and success criteria
...
Use this skill when a task explicitly matches `sales.product-demos` or when the user asks for product demo design support. It is designed for bounded task work where the agent needs concrete inputs, a repeatable procedure, and verification before handoff.
...
**Example A:** A user asks for product demo design help with a specific file or dataset; apply the six-step procedure and return a concise, evidence-backed artifact.

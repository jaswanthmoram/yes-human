...
steps:
  - Confirm the requested sales reporting framework outcome, scope, owner, and success criteria
...
Use this skill when a task explicitly matches `sales.sales-reporting` or when the user asks for sales reporting framework support. It is designed for bounded task work where the agent needs concrete inputs, a repeatable procedure, and verification before handoff.
...
**Example A:** A user asks for sales reporting framework help with a specific file or dataset; apply the six-step procedure and return a concise, evidence-backed artifact.

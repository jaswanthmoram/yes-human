...
steps:
  - Confirm the requested branch strategy and commit discipline outcome, scope, owner, and success criteria
...
Use this skill when a task explicitly matches `engineering.git-workflow` or when the user asks for branch strategy and commit discipline support. It is designed for bounded task work where the agent needs concrete inputs, a repeatable procedure, and verification before handoff.
...
**Example A:** A user asks for branch strategy and commit discipline help with a specific file or dataset; apply the six-step procedure and return a concise, evidence-backed artifact.

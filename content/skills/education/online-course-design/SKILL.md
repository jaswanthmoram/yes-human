...
activation_triggers:
  - help me with online course design
  - review online course design work
prerequisites:
...
steps:
  - Confirm the requested online course design outcome, scope, owner, and success criteria
...
## Trigger
Use this skill when a task explicitly matches `education.online-course-design` or when the user asks for online course design support. It is designed for bounded task work where the agent needs concrete inputs, a repeatable procedure, and verification before handoff.
...
## Examples
**Example A:** A user asks for online course design help with a specific file or dataset; apply the six-step procedure and return a concise, evidence-backed artifact.

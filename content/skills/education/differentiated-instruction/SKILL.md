...
activation_triggers:
  ...
  - review differentiated instruction work
prerequisites:
...
steps:
  - Confirm the requested differentiated instruction outcome, scope, owner, and success criteria
...
## Trigger
Use this skill when a task explicitly matches `education.differentiated-instruction` or when the user asks for differentiated instruction support. It is designed for bounded task work where the agent needs concrete inputs, a repeatable procedure, and verification before handoff.
...
## Examples
**Example A:** A user asks for differentiated instruction help with a specific file or dataset; apply the six-step procedure and return a concise, evidence-backed artifact.

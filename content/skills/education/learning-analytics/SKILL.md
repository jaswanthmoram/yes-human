...
activation_triggers:
  - help me with learning analytics
  - review learning analytics work
prerequisites:
...
steps:
  - Confirm the requested learning analytics outcome, scope, owner, and success criteria
...
Use this skill when a task explicitly matches `education.learning-analytics` or when the user asks for learning analytics support. It is designed for bounded task work where the agent needs concrete inputs, a repeatable procedure, and verification before handoff.
...
**Example A:** A user asks for learning analytics help with a specific file or dataset; apply the six-step procedure and return a concise, evidence-backed artifact.

...
triggers:
  ...
  - yes human task
  - rubric creation review
activation_triggers:
  - help me with rubric creation
  - review rubric creation work
prerequisites:
...
steps:
  - Confirm the requested rubric creation outcome, scope, owner, and success criteria
...
## Trigger
Use this skill when a task explicitly matches `education.rubric-creation` or when the user asks for rubric creation support. It is designed for bounded task work where the agent needs concrete inputs, a repeatable procedure, and verification before handoff.
...
## Examples
**Example A:** A user asks for rubric creation help with a specific file or dataset; apply the six-step procedure and return a concise, evidence-backed artifact.

...
activation_triggers:
  - help me with marketing funnels
  - review marketing funnels work
prerequisites:
...
steps:
  - Confirm the requested marketing funnels outcome, scope, owner, and success criteria
...
## Trigger
Use this skill when a task explicitly matches `marketing.marketing-funnels` or when the user asks for marketing funnels support. It is designed for bounded task work where the agent needs concrete inputs, a repeatable procedure, and verification before handoff.
...
## Examples
**Example A:** A user asks for marketing funnels help with a specific file or dataset; apply the six-step procedure and return a concise, evidence-backed artifact.

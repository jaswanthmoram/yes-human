...
activation_triggers:
  ...
  - help me with facebook ads
  - review facebook ads work
prerequisites:
...
steps:
  - Confirm the requested facebook ads outcome, scope, owner, and success criteria
...
## Trigger
Use this skill when a task explicitly matches `marketing.facebook-ads` or when the user asks for facebook ads support. It is designed for bounded task work where the agent needs concrete inputs, a repeatable procedure, and verification before handoff.
...
## Examples
**Example A:** A user asks for facebook ads help with a specific file or dataset; apply the six-step procedure and return a concise, evidence-backed artifact.

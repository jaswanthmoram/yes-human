...
## Trigger
Use this skill when a task explicitly matches `marketing.content-calendars` or when the user asks for content calendars support. It is designed for bounded task work where the agent needs concrete inputs, a repeatable procedure, and verification before handoff.

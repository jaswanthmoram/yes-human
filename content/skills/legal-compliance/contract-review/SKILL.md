...
steps:
  - Confirm the requested contract review outcome, scope, owner, and success criteria
...
## Trigger
Use this skill when a task explicitly matches `legal-compliance.contract-review` or when the user asks for contract review support. It is designed for bounded task work where the agent needs concrete inputs, a repeatable procedure, and verification before handoff.
...
## Examples
**Example A:** A user asks for contract review help with a specific file or dataset; apply the six-step procedure and return a concise, evidence-backed artifact.

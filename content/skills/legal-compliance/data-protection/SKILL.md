...
activation_triggers:
  - help me with data protection
  - review data protection work
prerequisites:
...
steps:
  - Confirm the requested data protection outcome, scope, owner, and success criteria
...
## Trigger
Use this skill when a task explicitly matches `legal-compliance.data-protection` or when the user asks for data protection support. It is designed for bounded task work where the agent needs concrete inputs, a repeatable procedure, and verification before handoff.
...
## Examples
**Example A:** A user asks for data protection help with a specific file or dataset; apply the six-step procedure and return a concise, evidence-backed artifact.

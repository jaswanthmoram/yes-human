...
activation_triggers:
  - help me with legal citations
  - review legal citations work
prerequisites:
...
steps:
  - Confirm the requested legal citations outcome, scope, owner, and success criteria
...
## Trigger
Use this skill when a task explicitly matches `legal-compliance.legal-citations` or when the user asks for legal citations support. It is designed for bounded task work where the agent needs concrete inputs, a repeatable procedure, and verification before handoff.
...
## Examples
**Example A:** A user asks for legal citations help with a specific file or dataset; apply the six-step procedure and return a concise, evidence-backed artifact.

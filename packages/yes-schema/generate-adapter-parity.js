...
const md = ["# ECC adapter parity", "", `Generated: ${new Date().toISOString()}`, "", "| ECC | yes-human | Status |", "|---|---|---|", "| orchestrate | yes run / yes workflow run | partial |", "| eval harness | yes eval * | yes |"].join("\n");
